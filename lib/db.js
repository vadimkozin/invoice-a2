...
// prettier-ignore
const customers = {
  "28956": {type: 'f', nameShort: 'Бегляров_ЮА', name: 'Бегляров Юрий Альбертович', nameFull: 'Бегляров Юрий Альбертович', INN: '', KPP: '', address: '...'},
  "28962": {type: 'u', nameShort: 'Фолио-авто', name: 'ООО «Фолио-авто»', nameFull: `${ooo()} «Фолио-авто»`, INN: '7705339860', KPP: '770501001', address: '119049, г. Москва, 1-ый Добрынинский пер., дом № 15/7'},
  "28965": {type: 'f', nameShort: 'Агуреев_АН', name: 'Агуреев Александр Николаевич', nameFull: `Агуреев Александр Николаевич`, INN: '', KPP: '', address: '...'},
  "28967": {type: 'u', nameShort: 'Пойнт_Пассат', name: 'ООО «Пойнт Пассат»', nameFull: `${ooo()} «Пойнт Пассат»`, INN: '7727220604', KPP: '771501001', address: 'г. Москва, ул. Б. Новодмитровская, д.23, стр.3, этаж 6, пом.I, оф.20'},
  "28973": {type: 'u', nameShort: 'Геокс_Рус', name: 'ООО «Геокс Рус»', nameFull: `${ooo()} «Геокс Рус»`, INN: '7718813164', KPP: '771501001', address: '127015, г. Москва, ул. Б.Новодмитровская, дом № 23, строение 3'},
  "28984": {type: 'u', nameShort: 'Зиландия', name: 'ООО «Зиландия»', nameFull: `${ooo()} «Зиландия»`, INN: '5044080919', KPP: '504401001', address: '141421, Московская область, Солнечногорский район, д. Елино, ул.Зеленоградская, стр.1'},
  "28987": {type: 'u', nameShort: 'Красноярскгазпром', name: 'ООО «Красноярскгазпром нефтегазпроект»', nameFull: `${ooo()} «Красноярскгазпром нефтегазпроект»`, INN: 'inn', KPP: 'kpp', address: '...'},
  "29005": {type: 'u', nameShort: 'Соушиал_Дискавери', name: 'ООО «Соушиал Дискавери Инжиниринг»', nameFull: `${ooo()} «Соушиал Дискавери Инжиниринг»`, INN: '7714969160', KPP: '771401001', address: '127083, г. Москва, ул. 8 Марта, дом 1, строение 12, помещение LII'},
  "29006": {type: 'u', nameShort: 'ТК_Корвет', name: 'ООО «ТК Корвет»', nameFull: `${ooo()} «ТК Корвет»`, INN: '7720783950', KPP: '772001001', address: '111402 г.Москва, ул.Кетчерская, д.10'},
  "29007": {type: 'u', nameShort: 'Хайлон-Рус', name: 'ООО «ТД Хайлон-Рус»', nameFull: `${ooo()} «ТД Хайлон-Рус»`, INN: '7713765710', KPP: '773601001', address: '119331, г. Москва, Проспект Вернадского, д. 29'},
  "29008": {type: 'u', nameShort: 'Континент', name: 'ООО «Континент»', nameFull: `${ooo()} «Континент»`, INN: '2374000391', KPP: '237201001', address: '352915, Краснодарский край, г. Армавир, улица Кропоткина, дом 387'},
...
// исполнитель для всех клиентов кроме АНО Редакция ..
const executer = {
...
const executerMg = {
  ...
  attrorneyDate: '10.02.2020', // доверенность Дата
}
...
const specialCustomers = {
  // АНО "Редакция парламентского телеевидения .."
  29011: {
