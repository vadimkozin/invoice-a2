...
const customers = {
  ...
  "28964": {type: 'f', nameShort: 'Малютина_ЕА', name: 'Малютина Екатерина Андреевна', nameFull: 'Малютина Екатерина Андреевна', inn: '', kpp: '', address: '...', dogNumberMg: '', dogDateMg: null, dogNumberVz, dogDateVz},
